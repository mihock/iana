    ...
    sidebarLayout(
        ...
        sidebarPanel = sidebarPanel(
            ...
            sliderInput(inputId = "kUniqueValues", 
                ...
                min = 1, max = 20, value = 9, step = 1, ticks = FALSE),
        ...
        mainPanel = mainPanel(
            navbarPage(
                ...
                tabPanel("Distribution",
                    ...
                    conditionalPanel(
                        ...
                        sliderInput(inputId = "histbinwidth", 
                            label = "Binwidth:",
                            min = 1, max = 20, value = 1, step = 1, ticks = FALSE,
                            animate = TRUE),
                        br(),
                    ...
                    tabPanel("Dimensionality Tests",
                        ...
                        fluidRow(
                            column(4, sliderInput(inputId = "nFactorsParallel", 
                                label = "Number of factors to show:*",
                    ...
                    tabPanel("Exploratory Factor Analysis",
                        ...
                        fluidRow(
                            column(8, sliderInput(inputId = "nFactors", 
                                ...
                                ticks = FALSE,
                                width = "100%")),
                            column(4, checkboxInput(inputId = "faIRT", 
                        ...
                        h4("Markers"),
                        fluidRow(
                            column(4, sliderInput(inputId = "faMinloading", 
                                label = "Minimum loading:",
                                min = 0.1, max = 0.7, value = 0.4, step = 0.05,
                                ticks = FALSE)),
                            column(4, sliderInput(inputId = "faMaxloading", 
                                label = "Maximum minor loading:",
                                min = 0.1, max = 0.7, value = 0.35, step = 0.05,
                                ticks = FALSE)),
                            column(4, sliderInput(inputId = "faComplexity", 
                ...
                tabPanel("Rasch",
                    ...
                    actionButton(inputId = "rasch_apply_button", label = "Run/Apply"),
                    p(""),
                ...
                tabPanel("IRT",
                    ...
                    actionButton(inputId = "mirt_apply_button", label = "Run/Apply"),
                    p(""),
                    fluidRow(
                        column(6, 
                            sliderInput(inputId = "mirt_nfactors", 
